@echo off
rem Builds build\percentage.exe: optimized, static CRT, no debug info.
setlocal
cd /d "%~dp0"
...
rc /nologo /I src /fo build\percentage.res src\percentage.rc || exit /b 1
